...
namespace MinimumSpaningTree
{
    public class MinimumSpaning
    {
      ...
      public int V, E; // V-> no. of vertices & E->no.of edges
       ...
       public MinimumSpaning(int v, int e)
        {
            V = v;
            E = e;
            edge = new Edge[E];
       ...
       public int Union(subset[] subsets, int x, int y)
        {
        ...
        public int KruskalMST()
        {
            ...
            Console.WriteLine("Kruskal's Minimum Cost Spanning Tree : "
                              + minimumCost);
            //Console.ReadLine();
